...
public class DataWindow extends JPanel {
	...
	public void paint(Graphics g) {
		...
		double vscale = (yn - y0) / 200.0; // light values range from 0 to 800
		...
		for (int vt = 200; vt >= 0; vt -= 20) { // tick every 200
			int v = y0 + (int) (vt * vscale);
			g.drawLine(x0 - 5, v, x0 + 5, v);
			g.drawString(Integer.toString(vt - 100), x0 - 38, v + 5);
		}
	...
	private void initComponents() {
		...
		vBox.add(dataPanel, java.awt.BorderLayout.CENTER);
		vBox.add(emptyPanel);
		...
		vBox.add(jScrollPane1, java.awt.BorderLayout.SOUTH);
		this.add(vBox);
